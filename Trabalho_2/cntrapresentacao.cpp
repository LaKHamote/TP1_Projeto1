...
void CntrAControle::executar(){
    ...
    char texto3[]="2 - Cadastrar usuário.";
    char texto4[]="3 - Acessar dados sobre Hospedagens.";
    char texto5[]="4 - Encerrar execução do sistema.";

    // Mensagens a serem apresentadas na tela de seleção de serviço.

    char texto6[]="Selecione um dos serviços : ";
    char texto7[]="1 - Selecionar serviços de usuário.";
    char texto8[]="2 - Selecionar serviços relacionados a Hospedagens.";
...
void CntrAUsuario::cadastrar(){
    ...
    try{
        ...
        mvprintw(linha/4 + 18,coluna/4,"%s",texto8);                                           // Informa formato incorreto.
        noecho();                                                                               // Desabilita eco.
        getch();                                                                                // Leitura de caracter digitado.
        echo();                                                                                 // Habilita eco.
        return;
    ...
    */
    ...
    /*
    if(cntrSUsuario->cadastrarUsuario(usuario))
