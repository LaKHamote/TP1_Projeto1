...
int main()
{
    ...
    CntrAControle *cntrApresentacaoControle;
    ...
    //stubServicoPessoal = new StubServicoPessoal();  precisa implementar os métodos da interface
    ...
    //cntrApresentacaoPessoal->setCntrSHospedagem(stubServicoHospedagem);
